...
import { gsap, ScrollTrigger, SplitText as GSAPSplitText } from '../../lib/motion.js'

// ReactBits' SplitText, adapted to the project's shared gsap/ScrollTrigger/
// SplitText singleton (lib/motion.js) instead of re-registering plugins.
// Character-by-character reveal — distinct from RevealText's line-mask
// reveal, reserved for standout headlines like page heroes.
